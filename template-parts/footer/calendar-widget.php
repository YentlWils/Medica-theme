    ...
    <div class="row">
        <div class="col-md-12">
            <div class="calendar-widget__row">
                <div class="col-sm-6 col-md-3 calendar-widget" data-bg-img="https://media.licdn.com/media/AAEAAQAAAAAAAAKlAAAAJGRiYjlmYmRhLTI1ZTYtNGE0OS1iZWI2LTI4MmVjY2ZkZWE1ZA.png">
                ...
                <div class="col-sm-6 col-md-3 calendar-widget hidden-xs" data-bg-img="http://www.designblast.be/uploads/projectimages/image_url/90d4426565ec188801c303a3fa709600.jpg">
                    <div class="calendar-widget__table">
                        <div class="calendar-widget__header">
                            <div class="calendar-widget__day">
                ...
                <div class="col-sm-6 col-md-3 calendar-widget hidden-sm hidden-xs" data-bg-img="http://www.medica.be/site/nivo-slider/medewerkerspoule.jpg">
                    <div class="calendar-widget__table">
                        <div class="calendar-widget__header">
                            <div class="calendar-widget__day">
                ...
                <div class="cold-sm-6 col-md-3 calendar-widget hidden-sm hidden-xs" data-bg-img="http://www.lespecialiste.be/sites/default/files/uploads/de-specialist-le-specialiste/2016/actuality/medica.png">
                    <div class="calendar-widget__table">
                        <div class="calendar-widget__header">
                            <div class="calendar-widget__day">
