...
$page_name =  get_option('fb_page'); //'TheFishHooks'; // Example: http://facebook.com/{PAGE_NAME}
$access_token =  get_option('fb_token'); //"EAACr9cwGFZCkBAIsZAhZAjFcVRKkIPJKS4hZBGpsvNkONovAvajRCR9R4QrDJy1chE3VKZBku4iHTy2NOg5ZB0sHoDA6HJNgYPDZAyKLDMzGzC6vjmKpNm2BvuDGfCYZBJQWcLZC085xG53NeFUC9f3lEU9EKf06LN2d1pZABJ2ozZCWAZDZD";
$limit = 10;
